...
typedef struct
{
   ...
   uint32 u32_Checksum;           //!< Variant struct checksum
   uint16 u16_StructLength;       //!< Variant structure length
   bool q_HasCanWakeup;           //!< 0=no, 1=yes
   bool q_HasEth;                 //!< 0=no, 1=yes
   bool q_HasFram;                //!< 0=no, 1=yes
   bool q_HasRs232;               //!< 0=no, 1=yes
   bool q_HasLin ;                //!< 0=no, 1=yes
   ...
   uint32 u32_Core1Rom;
   uint32 u32_Core2Rom;
   uint32 u32_Core0Clock;
   uint32 u32_Core1Clock;
   uint32 u32_Core2Clock;
} T_x_sys_hw_cfg;
