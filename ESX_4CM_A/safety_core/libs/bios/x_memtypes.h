...
#define X_MEM_STACKS_DSPR                       SECTION(".dspr.stacks.sc2", "f=wB")
#define X_MEM_STACKS_EMEM                       SECTION(".emem.stacks.sc2", "f=wB")
...
// Safe data manual placement (sorted in order of decreasing performance)
#define X_MEM_DSPR_DATA_SAFE                    SECTION(".dspr.data.sc2",    "f=w") // extremely fast
#define X_MEM_DSPR_BSS_SAFE                     SECTION(".dspr.bss.sc2",     "f=wB")
#define X_MEM_EMEM_DATA_SAFE                    SECTION(".emem.data.sc2.c",  "f=w") // pretty fast 2
#define X_MEM_EMEM_BSS_SAFE                     SECTION(".emem.bss.sc2.c",   "f=wB")
#define X_MEM_EMEM_DATA_UC_SAFE                 SECTION(".emem.data.sc2.uc", "f=w")
#define X_MEM_EMEM_BSS_UC_SAFE                  SECTION(".emem.bss.sc2.uc",  "f=wB")
...
// Map default memory types to this core's maximum safety level
#define X_MEM_DSPR_DATA                         X_MEM_DSPR_DATA_SAFE
#define X_MEM_DSPR_BSS                          X_MEM_DSPR_BSS_SAFE
#define X_MEM_EMEM_DATA                         X_MEM_EMEM_DATA_SAFE
#define X_MEM_EMEM_BSS                          X_MEM_EMEM_BSS_SAFE
#define X_MEM_EMEM_DATA_UC                      X_MEM_EMEM_DATA_UC_SAFE
#define X_MEM_EMEM_BSS_UC                       X_MEM_EMEM_BSS_UC_SAFE

// Public data is guaranteed to be readable by all safety levels, writes by lower safety levels are blocked
#define X_MEM_DSPR_DATA_PUBLIC                  X_MEM_DSPR_DATA_SAFE
#define X_MEM_DSPR_BSS_PUBLIC                   X_MEM_DSPR_BSS_SAFE
#define X_MEM_EMEM_DATA_PUBLIC                  X_MEM_EMEM_DATA_UC_SAFE
#define X_MEM_EMEM_BSS_PUBLIC                   X_MEM_EMEM_BSS_UC_SAFE
...
#define X_MEM_DATA_PUBLIC                       X_MEM_EMEM_DATA_PUBLIC
#define X_MEM_BSS_PUBLIC                        X_MEM_EMEM_BSS_PUBLIC

// Shared defaults, guaranteed to be readable and writable by all safety levels
#define X_MEM_DATA_SHARED                       X_MEM_EMEM_DATA_SHARED
#define X_MEM_BSS_SHARED                        X_MEM_EMEM_BSS_SHARED

// Deprecated
#define X_MEM_SHARED_DATA                       X_MEM_DATA_SHARED
#define X_MEM_SHARED_BSS                        X_MEM_BSS_SHARED
#define X_MEM_SHARED_DATA_SAFE                  X_MEM_DATA_PUBLIC
#define X_MEM_SHARED_BSS_SAFE                   X_MEM_BSS_PUBLIC
