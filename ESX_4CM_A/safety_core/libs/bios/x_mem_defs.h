...
// define the different safety levels that are availiable for this core
// NOTE: If you change or add safety levels you must adapt the t_IrVectCore0 in
//       function xb_os_cfg_install_scheduler_interrupt()
...
#define X_MEM_HEAP_COUNT          (4u) //!< number of defined heap areas
...
#define X_MEM_SAFETY_LEVEL_NON_INTERFERING   X_MEM_SAFETY_LEVEL_QM
#define X_MEM_SAFETY_LEVEL_SIL2              X_MEM_SAFETY_LEVEL_SAFE
