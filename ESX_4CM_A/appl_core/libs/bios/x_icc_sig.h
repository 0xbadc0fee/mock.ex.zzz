...
/*!
   \file
   \brief     Signals non-Safety-API for Inter-Core-Communication
...
/* -- Global Variables ---------------------------------------------------------------------------------------------- */
extern const uint8 gu8_IccSigPollFuncEnable;
...
sint16 x_icc_sig_unregister(const uint32 ou32_Signal);

sint16 x_icc_sig_unregister_os(T_x_icc_sig * const opt_Handle);
